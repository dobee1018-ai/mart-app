...
window.openRecipeDetail = function(recipeId) {
    ...
    data.searchKeywords.forEach(keyword => {
        ...
        if (match) {
            ...
            prodHtml += \`
                <div class="small-prod-card" style="min-width: 140px; border: 1px solid var(--border); border-radius: 12px; overflow: hidden; background: white; flex-shrink: 0;" onclick="openProductDetail('\${match.id}')">
                    ...
                    <div style="padding: 10px;">
                        ...
                        <strong style="font-size: 1rem;">\${match.price}</strong>
                    </div>
                </div>
            \`;
        }
...
const fs = require('fs');
const filePath = '/Users/hanseunghan/test.py/mart.app/mart_app_web/app.js';
let content = fs.readFileSync(filePath, 'utf8');
content += recipeLogic;
fs.writeFileSync(filePath, content, 'utf8');
console.log("Added recipe logic to app.js");
