...
image_map = {
    ...
    '한우': 'https://images.unsplash.com/photo-1607623814075-e51df1bdc82f?w=200&q=80',
    '삼겹살': 'https://images.unsplash.com/photo-1628268909376-e8c44bb3153f?w=200&q=80',
    '돼지': 'https://images.unsplash.com/photo-1602491453631-e2a5fc9f9f23?w=200&q=80',
    '닭': 'https://images.unsplash.com/photo-1587593810167-a84920ea0781?w=200&q=80',
    '오리': 'https://images.unsplash.com/photo-1516684732162-798a0062be99?w=200&q=80',
    '계란': 'eggs.png',
    '유정란': 'eggs.png',
    '메추리알': 'https://images.unsplash.com/photo-1516467508483-a7212febe31a?w=200&q=80',
    '불고기': 'https://images.unsplash.com/photo-1529692236671-f1f6cf9683ba?w=200&q=80',
    ...
    '휴지': 'https://images.unsplash.com/photo-1584556812952-905ffd0c611a?w=200&q=80',
    ...
    '식용유': 'https://images.unsplash.com/photo-1620619864275-c5464161eb3a?w=200&q=80'
}
    ...
    try:
        ...
        for p in products:
            for keyword, url in image_map.items():
                ...
                cat = p.get('category')
                if cat == 'fruit':
                    p['img'] = 'https://images.unsplash.com/photo-1610832958506-aa56368176cf?w=200&q=80'
                elif cat == 'veg':
                    p['img'] = 'https://images.unsplash.com/photo-1566385101042-1a0aa0c1268c?w=200&q=80'
                elif cat == 'ramen':
                    p['img'] = 'https://images.unsplash.com/photo-1612929633738-8fe44f7ec841?w=200&q=80'
                elif cat == 'snack':
                    p['img'] = 'https://images.unsplash.com/photo-1599599810769-bcde5a160d32?w=200&q=80'
                elif cat == 'meat':
                    p['img'] = 'https://images.unsplash.com/photo-1607623814075-e51df1bdc82f?w=200&q=80'
                elif cat == 'processed':
                    p['img'] = 'https://images.unsplash.com/photo-1583947215259-38e31be8751f?w=200&q=80'
